...
- **Лоадер** — фотографии в центральной ленте, заголовок и подзаголовок
- **Главная страница** — отдельные обложки PORTFOLIO/WORK для широкого экрана, ноутбука и телефона
- **PORTFOLIO** — блок о себе, альбомы, фотографии и выбор превью подраздела
- **WORK** — карточки услуг, стоимость, описание и редактируемые этапы
- **КОНТАКТЫ** — Telegram, Instagram, MAX, телефон, почта и другие ссылки

Изменения сначала остаются черновиком в браузере. Кнопка «Предпросмотр» показывает текущий раздел на компьютере и телефоне; публикация выполняется только после подтверждения.

Любая поддерживаемая фотография до **4 МБ** автоматически поворачивается по EXIF и сохраняется в **lossless AVIF**.
